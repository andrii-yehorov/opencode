export const dict = {
  ...
  "command.voice.toggleRecording": "Toggle voice recording",
  "command.voice.toggleRecording.description": "Start or stop local voice recording",
  ...
  "prompt.action.startRecording": "Start recording",
  "prompt.action.stopRecording": "Stop recording",
  "prompt.action.transcribing": "Transcribing...",
  "prompt.attachment.remove": "Remove attachment",
  "prompt.action.send": "Send",
  "prompt.action.stop": "Stop",
  "prompt.voice.error.microphonePermissionDenied": "Microphone permission denied",
  "prompt.voice.error.noAudioCaptured": "No audio captured",
  "prompt.voice.error.audioTooLarge": "Audio too large",
  "prompt.voice.error.unsupportedAudioFormat": "Unsupported audio format",
  "prompt.voice.error.localTranscriptionUnavailable": "Local transcription unavailable",
  "prompt.voice.error.transcriptionFailed": "Transcription failed",
