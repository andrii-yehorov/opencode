export const dict = {
  ...
  "prompt.voice.action.start": "Start voice input",
  "prompt.voice.action.stop": "Stop recording",
  "prompt.voice.action.transcribing": "Transcribing...",
  "prompt.voice.timeout.title": "Recording limit reached",
  "prompt.voice.error.permission": "Microphone access denied",
  "prompt.voice.error.unavailable": "Local transcription is unavailable",
  "prompt.voice.error.noSpeech": "No speech detected",
  "prompt.voice.error.failed": "Voice transcription failed",
